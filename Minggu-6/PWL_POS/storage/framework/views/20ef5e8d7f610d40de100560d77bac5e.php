            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <select name="level_id" id="level_id" class="form-control" required>
                        ...
                        <option <?php echo e(($l->level_id == $user->level_id)? 'selected' : ''); ?>

                            value="<?php echo e($l->level_id); ?>"><?php echo e($l->level_nama); ?></option>
                ...
                <div class="form-group">
                    ...
                    <input value="<?php echo e($user->username); ?>" type="text" name="username"
                        id="username" class="form-control" required>
                    <small id="error-username" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Nama</label>
                    <input value="<?php echo e($user->nama); ?>" type="text" name="nama" id="nama"
...
<?php endif; ?><?php /**PATH C:\laragon\www\Pemrograman-Web-Lanjut\Minggu-6\PWL_POS\resources\views/user/edit_ajax.blade.php ENDPATH**/ ?>